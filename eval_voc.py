...
def evaluate(model, test_dataset_file, test_loader=None, threshold=0.1):
    ...
    for image_path in tqdm(image_list):
        result = predict_image(model, image_path, root_img_directory='/content/drive/My Drive/DL_Fall_2020/Assignment_3/VOCdevkit_2007/VOC2007test/JPEGImages/', threshold=threshold)
